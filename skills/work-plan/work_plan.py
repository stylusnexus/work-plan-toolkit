...
DESCRIPTIONS = [
    ...
    ("where-was-i", "<track>",
     "Re-orient on one track after switching from another Claude Code session.",
     "When you swap to a different track mid-day and need to remember where you left off.",
     "/work-plan where-was-i ux-redesign"),
